            ...
            {matches =>
                ...
                (
                    <section class="section">
                        <img src="/assets/img/contact.png" style={{paddingTop: '2em'}}/>
                                        ...
                                        <div className="row">
                                            ...
                                            <input type="text" hidden={true} name="Website: Contact us" />
                                                <div className="row">
                                                    ...
                                                    <div className="col-md-12">
                                                        <div class="form-group">
                                                            <textarea placeholder="Your message" name="message" class="custom-form-control-textarea" id="message" rows="3" style={{width: '100%', background: 'transparent', border: '2px solid #1C1C1C', color: '#1C1C1C', padding: '.2em .5em', borderRadius: '7px'}}></textarea>
                                                        </div>
                                                    </div>
                                                    <div className="col-md-6">
                                                        <div class="form-group">
                                                            <button type="submit" class="btn btn-sm btn-primary" style={{width: '100%', background: '#FF6B05 0% 0% no-repeat padding-box', boxShadow: '0px 3px 6px #00000029',  borderColor: '#FF6B05', borderRadius: '39px', opacity: '1', color: 'white'}}>Send</button>
                                                        </div>
                                                    </div>
                                                </div>
